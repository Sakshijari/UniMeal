      ...
      <div className="card">
        <header className="page-header">
          ...
          <p className="page-subtitle">
            This is your single place to plan meals, keep an eye on what&apos;s
            in your kitchen, and make sure your student budget lasts all month.
          </p>
        </header>
        <section className="page-grid" aria-label="UniMeal overview">
          ...
          <div className="page-section">
            ...
            <p className="page-section-text">
              These buttons don&apos;t do anything yet. We&apos;ll wire them up
              to forms and Firestore in later steps.
            </p>
